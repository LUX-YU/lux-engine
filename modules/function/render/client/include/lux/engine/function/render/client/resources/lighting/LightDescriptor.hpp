...
namespace lux::render
{
    ...
    {
        Eigen::Vector3f LUX_MEMBER(display_name = Direction, tooltip = Light direction normalized) direction {
            0.f,
            -1.f,
            0.f
        };
        Eigen::Vector3f LUX_MEMBER(display_name = Color, color = true, tooltip = Light color RGB) color {
            1.f,
            1.f,
            1.f
        };
    ...
    {
        RenderLargePosition3D spatial_position{};
        Eigen::Vector3f LUX_MEMBER(display_name = Direction, tooltip = Spot direction normalized) direction {
            0.f,
            -1.f,
            0.f
        };
