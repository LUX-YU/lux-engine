...
#include <lux/engine/resource/asset/Asset.hpp>               // TAsset, asset_id_t, EAssetType
#include <lux/engine/resource/asset/material/MaterialAsset.hpp>  // MaterialData::kMaxParams / kMaxTextures
