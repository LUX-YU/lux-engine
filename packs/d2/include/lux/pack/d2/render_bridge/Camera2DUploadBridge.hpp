...
#include <lux/engine/render_bridge/RenderableBridgeContext.hpp>          // session()/scene()/view()/features()
#include <lux/pack/d2/world/systems/Camera2DSystem.hpp>                // activeCamera
#include <lux/pack/d2/world/components/Camera2DCacheComponent.hpp>     // Camera2DCacheComponent
...
namespace lux::pack
{
    ...
    class Camera2DUploadBridge final : public lux::render_bridge::TransientRenderableBridge
    {
    public:
