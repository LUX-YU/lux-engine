...
namespace lux::render
{
    ...
    Expected<FeatureHandle> DeferredGBufferCreateFn(void* scene_ptr, const void* param, size_t param_size)
    {
        ...
        static constexpr DGFill kShaderFills[] = {
            ...
            { .field = &DeferredGBufferCommConfig::gbuffer_unlit_fragment_shader,    .builtin = EBuiltinShader::GBUFFER_UNLIT_FRAG },
            { .field = &DeferredGBufferCommConfig::gbuffer_pbr_fragment_shader,      .builtin = EBuiltinShader::GBUFFER_PBR_FRAG },
            { .field = &DeferredGBufferCommConfig::gbuffer_stylized_fragment_shader, .builtin = EBuiltinShader::GBUFFER_STYLIZED_FRAG },
