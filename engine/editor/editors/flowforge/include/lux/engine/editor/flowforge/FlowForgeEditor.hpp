...
namespace lux::editor::flowforge
{
    ...
    class LUX_EDITOR_FLOWFORGE_PUBLIC LUX_OBJECT() FlowForgeEditor final : public object::Object<FlowForgeEditor>,
    ...
    [[nodiscard]] LUX_EDITOR_FLOWFORGE_PUBLIC EditorResult<std::unique_ptr<DocumentOpening>> openFlowForgeDocument(
