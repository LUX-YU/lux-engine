...
namespace lux::editor
{
    ...
    class LUX_EDITOR_CONTEXT_PUBLIC HistoryTargetRegistration final
    {
    public:
    ...
    private:
        ...
        HistoryTargetRegistration(
            std::weak_ptr<detail::ActiveEditHistoryControl> control, HistoryTargetHandle handle
        ) noexcept;
    ...
    class LUX_EDITOR_CONTEXT_PUBLIC ActiveEditHistory final
    {
    public:
        ...
        [[nodiscard]] editing::EditResult<HistoryTargetRegistration> registerTarget(editing::EditHistoryTarget& target
        ) noexcept;
