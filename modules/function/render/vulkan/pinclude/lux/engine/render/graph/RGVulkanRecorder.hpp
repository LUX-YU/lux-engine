...
namespace lux::render
{
    ...
    public:
        ...
        Expected<RGRecordContext> allocateRecordContext(
        ...
        void refreshDynamicImportedResources(RGResourceState& resource_state, const RGCompiledGraph& compiled_graph)
            override;
    ...
    private:
        ...
        std::optional<RenderError> preCreateImageViews(
        ...
        void applyLocalReadBoundaryState(
            VkCommandBuffer cmd,
