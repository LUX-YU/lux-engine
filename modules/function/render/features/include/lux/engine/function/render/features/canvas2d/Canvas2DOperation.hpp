...
//  into <lux/engine/function/render/features/genops/Canvas2DOperation.ops.hpp>; include THAT
...
namespace lux::render
{
    ...
    LUX_RENDER_FEATURE_CLIENT_PUBLIC void updateVisual(
        Canvas2DProxy proxy,
        RenderSceneId scene,
        Image2DHandle handle,
        const float uv[4],
    ...
    LUX_RENDER_FEATURE_CLIENT_PUBLIC void updatePixelFieldKey(
        Canvas2DProxy proxy,
        RenderSceneId scene,
        PixelFieldInstanceHandle handle,
        float priority,
    ...
    LUX_RENDER_FEATURE_CLIENT_PUBLIC void updateTilemapKey(
        Canvas2DProxy proxy,
        RenderSceneId scene,
        Tile2DInstanceHandle handle,
        float priority,
