...
| old hierarchy preorder/interval | `HierarchyIndex` | REUSE algorithm | sorted preorder/subtree intervals | hierarchy/transform tests |
| old transform dirty propagation | Transform Systems | REUSE algorithm | dirty subtree propagation | transform pilot test |
