 ...
 *
 * All strings used elsewhere in a `.luxworld` / `.luxpackage` / `.luxasset`
...
namespace lux::serialize
{
    ...
    class LUX_CORE_SERIALIZATION_PUBLIC NameTable
    {
    public:
        NameTable();
    ...
    private:
        ...
        // for `intern("")`).
        // index_ stores views into these strings. A deque keeps both heap-backed
        // and small-string buffers address-stable when new names are appended.
