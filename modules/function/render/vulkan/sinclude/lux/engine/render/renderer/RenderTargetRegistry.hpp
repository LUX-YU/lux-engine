...
namespace lux::render
{
    ...
    public:
        ...
        [[nodiscard]] RenderTargetId insert(Entry&& e)
        {
        ...
        void setSurfaceTarget(RenderTargetId id) noexcept
        {
            surface_target_ = id;
        }
    ...
    private:
        ...
        std::vector<std::pair<uint64_t, std::unique_ptr<OffscreenImagePool>>> deferred_pools_;
    };
