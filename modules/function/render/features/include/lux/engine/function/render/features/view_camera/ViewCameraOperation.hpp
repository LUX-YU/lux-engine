...
namespace lux::render
{
    ...
    struct LUX_OP(lane = program, kind = bulk, name = ViewCameraRemove, method = remove) ViewCameraRemovePayload
    {
        RenderSceneId scene_id{};
        ViewHandle view{};
    };
    ...
    LUX_RENDER_FEATURE_CLIENT_PUBLIC void viewCameraUpdate(
    ...
    LUX_RENDER_FEATURE_CLIENT_PUBLIC void viewCameraUpdateTransient(
        ViewCameraProxy proxy,
        RenderSceneId scene_id,
        ViewHandle view,
        const float view_matrix[16],
