...
namespace lux::object
{
    ...
    namespace detail
    {
        ...
        [[nodiscard]] LUX_CORE_PUBLIC lux::cxx::expected<Connection, EObserveError> observeDynamicErased(
            LuxObject& sender,
    ...
    private:
        ...
        observeStaticIndexed(const detail::SignalDescriptor& signal, detail::ObjectInvokeThunk invoke);

        [[nodiscard]] Connection observeCallableIndexed(
            const detail::SignalDescriptor& signal,
            detail::ObjectInvokeThunk invoke,
            std::shared_ptr<void> context
        );
