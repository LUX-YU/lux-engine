...
namespace lux::render
{
    ...
    inline constexpr std::array kBuiltinShadingModels{
        ...
        BuiltinShadingModel{
            EShadingModel::LEGACY_LIT_BASE,
            ELightingTechnique::LegacyLit},
        BuiltinShadingModel{
            EShadingModel::PbrMetallicRoughness,
            ELightingTechnique::PbrMetallicRoughness},
        BuiltinShadingModel{
            EShadingModel::STYLIZED,
            ELightingTechnique::Stylized},
