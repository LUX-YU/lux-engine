...
namespace lux::render
{
    ...
    void StandardViewCameraFeature::addPasses(RGBuilder& /*builder*/)
    {
        // Resource owner only — no render-graph passes.
    }

    // The factory (kStandardViewCameraFeatureFactory) + its createFn + the camera
