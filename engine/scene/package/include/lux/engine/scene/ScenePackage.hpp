#pragma once
/**
 * @file ScenePackage.hpp
 * @brief Engine-owned cooked scene package model (LXSC v1 semantics).
 *
...
namespace lux::scene
{
    inline constexpr std::uint32_t kScenePackageMagic = 0x4353584cu;
    inline constexpr std::uint32_t kScenePackageVersion = 1u;

    struct ScenePackageIdTag final {};
    using ScenePackageId = lux::ecs::UuidId<ScenePackageIdTag>;
    ...
    struct RequiredExtension final
    {
        ...
        friend bool operator==(const RequiredExtension&, const RequiredExtension&) =
            default;
    };
    ...
    struct SceneFeatureRequest final
    {
        ...
        friend bool operator==(
            const SceneFeatureRequest&,
            const SceneFeatureRequest&) = default;
    };
    ...
    struct SectionRecord final
    {
        ...
        friend bool operator==(const SectionRecord&, const SectionRecord&) =
            default;
    };
    ...
    struct ScenePackage final
    {
        ...
        friend bool operator==(const ScenePackage&, const ScenePackage&) =
            default;
    };
} // namespace lux::scene
