function(engine_target_add_ecs_component_codegen)
    ...
    lux_codegen_add_projection(
        JOB ${ARGS_NAME}
        NAME ecs_schema
        TEMPLATE ${PROJECT_SOURCE_DIR}/engine/ecs/schema/template/ecs_schema.template
        OUTPUT_ROOT ${LUX_GENERATE_HEADER_DIR}
    ...
    lux_codegen_add_projection(
        ...
        OUTPUT_ROOT ${LUX_GENERATE_HEADER_DIR}
        OUTPUT_SUFFIX .ecs_load.hpp
        JSON_FIELD "{\"projection_symbol\":\"${ARGS_SYMBOL}\"}"
    )
    lux_codegen_add_projection(
        JOB ${ARGS_NAME}
        NAME ecs_persistence
        TEMPLATE ${PROJECT_SOURCE_DIR}/engine/ecs/schema/template/ecs_persistence.template
        OUTPUT_ROOT ${LUX_GENERATE_HEADER_DIR}
        OUTPUT_SUFFIX .ecs_persistence.hpp
        JSON_FIELD "{\"projection_symbol\":\"${ARGS_SYMBOL}\"}"
    )
