...
namespace lux::object
{
    namespace detail
    {
        ...
        [[nodiscard]] MessageEnvelope makeQueuedSignalMessage(
            lux::cxx::intrusive_ptr<ConnectionControl> control, const void *payload) noexcept
        {
    ...
    namespace detail
    {
        ...
        struct GeneratedSignalAccess final
        {
            ...
            [[nodiscard]] static consteval SignalType make(std::size_t index,
                                                           std::size_t lineage_size) noexcept
            {
