...
namespace lux::input
{
    // Stable physical codes. Platform sources translate their native events
    // into these values before an InputSnapshot is published.
    enum class EKey : int
    {
        UNKNOWN                = -1,
        KEY_SPACE              = 32,
    ...
    using PhysicalInput = std::variant<
        KeyInput,
        MouseButtonInput,
        MouseAxisInput,
        TouchInput
