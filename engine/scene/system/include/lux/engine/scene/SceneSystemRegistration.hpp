...
[[nodiscard]] constexpr EComponentObservation operator|(EComponentObservation left,
                                                        EComponentObservation right) noexcept
{
...
using InstallSceneSystemFn =
    lux::cxx::expected<void, SceneSystemBuildFailure> (*)(SceneBuilder &builder, SceneSystemDescription description) noexcept;
using ProjectSceneSystemObjectFn = object::LuxObject *(*)(void *object) noexcept;

template <class Type> [[nodiscard]] consteval ProjectSceneSystemObjectFn sceneSystemObjectProjection() noexcept
{
