...
function(lux_script_abilities)
    ...
    lux_codegen_add_projection(
        JOB ${job}
        NAME script_ability_native
        TEMPLATE ${template_dir}/script_ability_native.template
        OUTPUT_ROOT ${output_root}
        OUTPUT_SUFFIX .ability.native.generated.hpp
        FLAT_OUTPUT
    )
    lux_target_add_codegen(
        ...
        JOB ${job}
        PROJECTIONS
            script_ability_semantics
            script_ability_cpp
            script_ability_schema_writer
            script_ability_lua
            script_ability_native
        DONT_ADD_TO_SOURCE
    )
