...
public:
  explicit SelfDestroyingReceiver(
      std::unique_ptr<SelfDestroyingReceiver> *owner) noexcept
      : owner_(owner) {}
...
int main() {
  ...
  {
    Receiver receiver;
    auto observed = sender.observe<MultiSender::changed, &Receiver::receive,
  ...
  lux::object::ObjectWeakRef expired_sender;
  {
    ...
    auto observed =
        owned_sender->observe<MultiSender::changed, &Receiver::receive,
  ...
  auto move_connection =
      sender.observe<MultiSender::moveOnly, &Receiver::receiveMoveOnly,
  ...
  auto self_connection =
      sender.observe<MultiSender::changed, &SelfDestroyingReceiver::receive,
