#pragma once
/**
 * @file SceneSettingsPanel.hpp
 * @brief Scene data and renderer-capability settings panel.
 *
...
namespace lux::editor
{
    ...
    class LUX_EDITOR_PUBLIC SceneSettingsPanel : public lux::ui::Panel
    {
    public:
        explicit SceneSettingsPanel(std::string title);
    ...
    private:
        ...
        /// "Scene" tab: reflected Render View and visual state settings.
        void drawSceneTab();
