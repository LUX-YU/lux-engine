...
namespace lux::ecs::scene_format
{
    namespace
    {
        ...
        [[nodiscard]] EntitySectionCodecFailure decodeFailure(
    ...
    EntitySectionCodecResult<std::vector<std::byte>>
    ...
    EntitySectionCodecResult<EntitySectionImage>
        ...
        const EntitySectionCodecLimits& limits) noexcept
    {
        ...
        {
            return lux::cxx::unexpected(failure(
                EEntitySectionCodecError::TRUNCATED,
                "truncated LXES header"));
        }
        if (magic != kEntitySectionImageMagic)
        {
            return lux::cxx::unexpected(failure(
                EEntitySectionCodecError::BAD_MAGIC,
                "LXES magic mismatch"));
        }
        if (version != kEntitySectionImageVersion)
        {
            return lux::cxx::unexpected(failure(
                EEntitySectionCodecError::UNSUPPORTED_VERSION,
        ...
        {
            return lux::cxx::unexpected(failure(
                EEntitySectionCodecError::TRAILING_BYTES,
