...
class LUX_FUNCTION_PUBLIC RenderScene
{
  public:
    ...
    /// Ordered owner publication. Drawing or pausing does not change this clock.
    void publishTime(std::int64_t elapsed_ns, std::int64_t delta_ns, std::uint64_t step) noexcept
    {
  ...
  private:
    ...
    std::int64_t elapsed_ns_{}, delta_ns_{};
    std::uint64_t simulation_step_{};
    float maintenance_time_{};
