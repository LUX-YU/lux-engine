...
namespace lux::scene
{
    namespace
    {
        [[nodiscard]] ScenePackageCodecFailure failure(
        ...
        [[nodiscard]] bool validFeature(
            const SceneFeatureId& id,
            const ScenePackageCodecLimits& limits) noexcept
        {
            return id.isValid() &&
        ...
        [[nodiscard]] ScenePackageCodecResult<void> validateRequirements(
            ...
            const ScenePackageCodecLimits& limits)
        {
            ...
            for (const auto& value : extensions)
            {
                ...
                {
                    return lux::cxx::unexpected(failure(
                        ScenePackageCodecError::InvalidName,
        ...
        [[nodiscard]] ScenePackageCodecResult<void> validateSectionRecordImpl(
        ...
        [[nodiscard]] ScenePackageCodecResult<void> validatePackageImpl(
