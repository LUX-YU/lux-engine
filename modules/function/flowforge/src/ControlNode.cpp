...
namespace lux::flowforge
{
    ...
    ForLoopNode::ForLoopNode(uint64_t id)
        ...
        first_index_(this, DataPinInfo{ "First Index", &lux::meta::ref_type_of_v<uint64_t> }, true),
        last_index_(this, DataPinInfo{ "Last Index", &lux::meta::ref_type_of_v<uint64_t> }, true),
        index_(this, DataPinInfo{ "Index", &lux::meta::ref_type_of_v<uint64_t> })
    {
        setName("For Loop");
        first_index_.setConstantData(lux::meta::RuntimeObject(uint64_t{0}));
        last_index_.setConstantData(lux::meta::RuntimeObject(uint64_t{10}));
    }
