...
class LUX_FUNCTION_PUBLIC Renderer
{
  public:
    ...
    void removeScene(RenderSceneId scene_id, uint64_t last_possible_submission);
    ...
    bool renderSingleView(RenderScene &scene, View &view, const RenderTargetBinding &binding, FrameRuntime &rt,
  ...
  private:
    ...
    void renderView(RenderScene &scene, SceneGraphState &gs, View &view, const DrawRequest &req, FrameRuntime &rt,
                    uint32_t cross_view_index = 0);
