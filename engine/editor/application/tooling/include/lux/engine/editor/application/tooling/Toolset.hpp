...
#include <lux/engine/editor/application/tooling/visibility.h>
...
namespace lux::editor::application
{
    ...
    /**
     * Owns concrete long-lived L4 Tool facilities for one EditorApplication.
     *
     ...
     * is destroyed.
     */
    class LUX_EDITOR_TOOLING_PUBLIC Toolset final
    {
    public:
        Toolset();
        ~Toolset() noexcept;
