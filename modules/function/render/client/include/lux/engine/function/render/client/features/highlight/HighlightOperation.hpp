...
namespace lux::render
{
    ...
    static_assert((kInstanceFlagHighlight &
    ...
    struct LUX_COMM_CONFIG(prefix=Highlight, id=lux.render.highlight.v1, display=Highlight, requires=lux.render.mesh_stack.v1,
                           custom_create=true)
    HighlightCommConfig
    {
