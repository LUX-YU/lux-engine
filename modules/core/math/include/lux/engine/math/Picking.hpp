...
namespace lux::math
{
    ...
    void screenToRay(
        Scalar screen_x, Scalar screen_y,
        Scalar viewport_width, Scalar viewport_height,
        ...
        Ray& out_ray)
    {
        ...
        const Eigen::Matrix<Scalar, 3, 1> dir =
            far_world.template head<3>() * near_world.w()
          - near_world.template head<3>() * far_world.w();
