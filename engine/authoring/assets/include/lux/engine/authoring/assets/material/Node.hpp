...
#include <lux/engine/authoring/assets/material/DataPin.hpp>
...
namespace lux::rdesc
{
    ...
    LUX_ENGINE_AUTHORING_ASSETS_PUBLIC const char* toString(
        EMatNodeKind kind) noexcept;

    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC Node
    {
    public:
