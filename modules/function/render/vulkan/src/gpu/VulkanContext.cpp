 ...
 */
static inline VkBool32 debug_report_callback(VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objectType,
                                             uint64_t object, size_t location, int32_t messageCode,
                                             const char *pLayerPrefix, const char *pMessage, void *pUserData);

// InstanceContext implementation
InstanceContext::InstanceContext(const std::vector<const char *> &required_extensions, DebugCallback debug_callback,
...
VkBool32 debug_report_callback(VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objectType, uint64_t object,
                               size_t location, int32_t messageCode, const char *pLayerPrefix, const char *pMessage,
                               void *pUserData)
{
    DebugCallbackInfo info{.flags = flags,
