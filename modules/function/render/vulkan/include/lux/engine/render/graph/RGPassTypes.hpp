...
namespace lux::render
{
    ...
    using DSResolverFn = VkDescriptorSet (*)(const void* resource, uint32_t frame_slot, uint32_t view_id);
    ...
    struct RGPassDescription
    {
        ...
        lux::cxx::SmallVector<std::string, 4>
            after_passes; ///< Explicit ordering: this pass must execute after the named passes.
        ...
        [[nodiscard]] bool hasKernel() const noexcept
        {
            return kernel_id != kInvalidKernelId;
        }
    };
