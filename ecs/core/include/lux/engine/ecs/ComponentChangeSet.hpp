...
namespace lux::ecs
{
    ...
    [[nodiscard]] inline auto componentView(
        lux::ecs::Registry& reg, ComponentList<Rs...>, ComponentList<Es...>)
    {
    ...
    class ExtractionChangeSet<C, ComponentList<Rs...>, ComponentList<Es...>>
    {
        using Storage = std::remove_reference_t<
            decltype(std::declval<lux::ecs::Registry&>()
    ...
    public:
        ...
        void attach(lux::ecs::Registry& reg, entt::id_type id, Declare&& declare)
        {
            reg_     = &reg;
            ...
            componentView<C>(reg, ComponentList<Rs...>{}, ComponentList<Es...>{})
                .each([&s](lux::ecs::Entity e, auto&&...) { s.emplace(e); });
        }
        ...
        template <class Fn>
        void drain(lux::ecs::Registry& reg, std::string_view owner, Fn&& fn)
        {
            scratch_.clear();
            ...
            componentView<C>(reg, ComponentList<Rs...>{}, ComponentList<Es...>{})
                .each([&](lux::ecs::Entity e, C& c, auto&&...)
            {
