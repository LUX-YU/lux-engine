...
namespace lux::editor::gui
{
    namespace
    {
        ...
        {
            return lux::cxx::unexpected(EditorFailure{EEditorError::INVALID_ARGUMENT, "camera"});
        }
    } // namespace
    ...
    EditorResult<void> SceneCamera::focus(const Eigen::Vector3d &center, double radius) noexcept
    {
    ...
    EditorResult<void> SceneCamera::move(const CameraMotion &motion) noexcept
    {
    ...
    EditorResult<Eigen::Matrix4d> SceneCamera::projection(double aspect) const noexcept
    {
