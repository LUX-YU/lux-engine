...
namespace lux::scene
{
                         ...
                         editor = true) Camera
    {
        ...
        // Runtime association only. The View owner supplies its actual extent;
        // neither field is serialized or grants ownership of the View.
        render::ViewHandle LUX_NO_MEMBER() view {};
        double LUX_NO_MEMBER() aspect_ratio { 1.0 };
    };
    ...
    [[nodiscard]] LUX_ENGINE_SCENE_RENDER_PUBLIC lux::cxx::expected<Eigen::Matrix4d, ECameraError>
    cameraProjection(const Camera &camera) noexcept;
    ...
    [[nodiscard]] LUX_ENGINE_SCENE_RENDER_PUBLIC lux::cxx::expected<Eigen::Matrix4d, ECameraError>
    cameraView(const Eigen::Affine3d &world, const Eigen::Vector3d &origin) noexcept;
} // namespace lux::scene
