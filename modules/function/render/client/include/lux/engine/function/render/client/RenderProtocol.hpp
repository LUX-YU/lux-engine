...
inline constexpr TypeId PublishSceneTime = 40; ///< ordered instance time, independent of render maintenance
...
struct PublishSceneTimePayload
{
    RenderSceneId scene_id{};
...
static_assert(std::is_trivially_copyable_v<PublishSceneTimePayload>);
...
template <> struct CommandTraits<DestroyScenePayload>
{
