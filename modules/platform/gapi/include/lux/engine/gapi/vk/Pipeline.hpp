...
namespace lux::gapi::vk
{
    ...
    public:
        ...
        )
        {
            VK_FUNC_INVOKE(
                ...
                "Failed to create PipelineLayout object",
                device,
                &info,
                allocator,
                &layout
        ...
        inline const VkPipelineLayout* operator&() const noexcept
        {
            return &layout;
        }
        ...
        inline const VkPipelineLayout* handlePtr() const noexcept
        {
            return &layout;
        }
    ...
    public:
        ...
        Pipeline(VkDevice device, const VkGraphicsPipelineCreateInfo& info, VkAllocationCallbacks* allocator = nullptr)
        {
            VK_FUNC_INVOKE(
                ...
                "Failed to create Pipeline object",
                device,
                VK_NULL_HANDLE,
                1,
                &info,
        ...
        inline const VkPipeline* operator&() const noexcept
        {
            return &pipeline;
        }
        ...
        inline const VkPipeline* handlePtr() const noexcept
        {
            return &pipeline;
        }
    ...
    /*
        typedef struct VkGraphicsPipelineCreateInfo
        {
            ...
            /// Specifies the type of this structure. For VkGraphicsPipelineCreateInfo, it should be
       VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO.
            ...
            /// Flags specifying options for pipeline creation, such as VK_PIPELINE_CREATE_DISABLE_OPTIMIZATION_BIT or
       VK_PIPELINE_CREATE_ALLOW_DERIVATIVES_BIT.
            ...
            /// Pointer to a VkPipelineVertexInputStateCreateInfo structure defining vertex input state, including
       vertex binding and attribute descriptions.

            const VkPipelineInputAssemblyStateCreateInfo*  pInputAssemblyState;
            /// Pointer to a VkPipelineInputAssemblyStateCreateInfo structure defining input assembly state, including
       primitive topology and restart index enabling.

            const VkPipelineTessellationStateCreateInfo*   pTessellationState;
            /// Pointer to a VkPipelineTessellationStateCreateInfo structure defining tessellation state, mainly used to
       specify the number of control points. Used only if tessellation shaders are used.

            const VkPipelineViewportStateCreateInfo*       pViewportState;
            /// Pointer to a VkPipelineViewportStateCreateInfo structure defining the number and details of viewports
       and scissor rectangles.

            const VkPipelineRasterizationStateCreateInfo*  pRasterizationState;
            /// Pointer to a VkPipelineRasterizationStateCreateInfo structure defining rasterization state, including
       fill mode, cull mode, depth bias, etc.

            const VkPipelineMultisampleStateCreateInfo*    pMultisampleState;
            /// Pointer to a VkPipelineMultisampleStateCreateInfo structure defining multisample state, including sample
       count and sample mask.

            const VkPipelineDepthStencilStateCreateInfo*   pDepthStencilState;
            /// Pointer to a VkPipelineDepthStencilStateCreateInfo structure defining depth and stencil test state,
       including depth test, depth write, and stencil test.

            const VkPipelineColorBlendStateCreateInfo*     pColorBlendState;
            /// Pointer to a VkPipelineColorBlendStateCreateInfo structure defining color blend state, including blend
       attachments and blend constants.

            const VkPipelineDynamicStateCreateInfo*        pDynamicState;
            /// Pointer to a VkPipelineDynamicStateCreateInfo structure specifying the set of dynamic states that can be
       changed during command buffer execution.
            ...
            /// Index of the pipeline within the create array that this pipeline will derive from. Mainly used for
       pipeline derivatives. } VkGraphicsPipelineCreateInfo;
    */
