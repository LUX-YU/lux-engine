...
#include <lux/engine/toolchain/shader/visibility.h>
...
namespace lux::shadergen::glsl
{
    ...
    LUX_TOOLCHAIN_SHADER_COMPILER_PUBLIC lux::cxx::expected<std::string, std::string>
    ...
    LUX_TOOLCHAIN_SHADER_COMPILER_PUBLIC lux::cxx::expected<CompiledShader, std::string>
