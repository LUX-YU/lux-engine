...
namespace lux::asset
{
	class LUX_ASSET_PUBLIC MeshSerDeser : public TAssetSerDeser<MeshLoadConfig>
	{
	public:
		 ...
		 */
		[[nodiscard]] static lux::cxx::expected<std::unique_ptr<lux::rdesc::Mesh>, EAssetError>
		...
		[[nodiscard]] static lux::cxx::expected<std::vector<std::byte>, EAssetError>
		encodeData(const asset_id_t& id, const lux::rdesc::Mesh& mesh) noexcept;
