...
int main(int argc, char** argv)
{
    ...
    const_cast<DataInPin&>(*callf->argPins()[0]).setConstantData(lux::meta::RuntimeObject(int32_t{10}));
    ...
    std::printf("---- IR ----\n%s------------\n", text.c_str());
    check(text.find("func.func @fib") != std::string::npos, "module contains func.func @fib");
    check(text.find("func.func @main") != std::string::npos, "module contains func.func @main");
    check(text.find("call @fib") != std::string::npos, "graph calls lower to func.call @fib");
