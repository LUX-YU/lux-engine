...
namespace lux::meta
{
    ...
    static constexpr inline std::array<std::array<bool, p_base_type_num>, p_base_type_num> p_lossless_convert_table = {{
        ...
        /* dst=Uint32  */
        {{false, true, false, true, false, true, false, true, false, false, false, false, false, false}},
    ...
    static inline bool recordCompatible(const RefType* dst, const RefType* src) noexcept
    {
        ...
        auto iter = std::find(src_class->parent_chain.begin(), src_class->parent_chain.end(), dst_class->hash);
