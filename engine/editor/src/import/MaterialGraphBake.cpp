...
namespace lux::editor
{
        ...
        const std::vector<lux::asset::asset_id_t>& slot_texture_ids)
    {
        ...
        // 2) store the AUTHORING GRAPH — the SSOT. shading-model / param defaults /
        //    render-state / texture-slot count are DERIVED from it at upload (the
        //    bridge), not duplicated in the payload. Also the re-edit/re-bake source.
