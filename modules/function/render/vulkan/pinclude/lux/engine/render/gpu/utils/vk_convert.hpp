...
namespace lux::render::vk_convert
{
    ...
    inline VkFormat toVk(ETextureFormatHint f) noexcept
    {
        switch (f)
        {
        case ETextureFormatHint::RGBA8:
            return VK_FORMAT_R8G8B8A8_UNORM;
        case ETextureFormatHint::SRGBA8:
            return VK_FORMAT_R8G8B8A8_SRGB;
        case ETextureFormatHint::BGRA8:
            return VK_FORMAT_B8G8R8A8_UNORM;
        case ETextureFormatHint::SBGRA8:
            return VK_FORMAT_B8G8R8A8_SRGB;
        case ETextureFormatHint::RGBA16F:
    ...
    inline ETextureFormatHint fromVk(VkFormat f) noexcept
    {
        ...
        case VK_FORMAT_R8G8B8A8_UNORM:
            return ETextureFormatHint::RGBA8;
        case VK_FORMAT_R8G8B8A8_SRGB:
            return ETextureFormatHint::SRGBA8;
        case VK_FORMAT_B8G8R8A8_UNORM:
            return ETextureFormatHint::BGRA8;
        case VK_FORMAT_B8G8R8A8_SRGB:
            return ETextureFormatHint::SBGRA8;
        case VK_FORMAT_R16G16B16A16_SFLOAT:
            return ETextureFormatHint::RGBA16F;
