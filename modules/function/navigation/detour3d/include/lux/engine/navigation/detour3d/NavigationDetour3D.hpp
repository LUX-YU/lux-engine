...
namespace lux::navigation::detour3d
{
    ...
    inline constexpr std::string_view kNavigationRegion3DContentTypeName = "lux.navigation.region3d";
    ...
    struct NavigationRegion3DBlob final
    {
        ...
        {
            return region.valid() && schema_version == kNavigationRegion3DSchemaVersion && !payload.empty();
        }
    };
    ...
    [[nodiscard]] LUX_FUNCTION_PUBLIC lux::cxx::expected<NavigationRegion3DBlob, NavigationRegion3DFailure>
    ...
    [[nodiscard]] LUX_FUNCTION_PUBLIC lux::cxx::expected<PreparedNavigationRegion3D, NavigationRegion3DFailure>
    ...
    public:
        ...
        PreparedNavigationRegion3D& operator=(PreparedNavigationRegion3D&&) noexcept;
        PreparedNavigationRegion3D(const PreparedNavigationRegion3D&) = delete;
        PreparedNavigationRegion3D& operator=(const PreparedNavigationRegion3D&) = delete;
    ...
    class LUX_FUNCTION_PUBLIC Navigation3DBackend final : public std::enable_shared_from_this<Navigation3DBackend>
    {
    public:
        ...
        [[nodiscard]] NavigationPathResult query(const NavigationPathRequest& request) const noexcept;
    ...
    public:
        ...
        NavigationRegion3DLease& operator=(const NavigationRegion3DLease&) = delete;
    ...
    private:
        ...
        ENavigationRegion3DLeaseState state_{ENavigationRegion3DLeaseState::STAGING};
