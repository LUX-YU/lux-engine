 ...
 * Gaussian falloff to each point sprite, producing smooth circular splats that
...
namespace lux::render
{
    ...
    public:
        ...
        {
            max_size_atomic_.store(pixels, std::memory_order_relaxed);
        }
    ...
    private:
        ...
        std::atomic<float> max_size_atomic_{30.0f};
        Config cfg_{};
    };
