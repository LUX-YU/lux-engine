...
[[nodiscard]] LUX_OBJECT_BENCHMARK_BASELINE_API BaselineReceiver *
createBaselineReceiver();
LUX_OBJECT_BENCHMARK_BASELINE_API void
destroyBaselineReceiver(BaselineReceiver *) noexcept;
[[nodiscard]] LUX_OBJECT_BENCHMARK_BASELINE_API BaselineFunction
baselineFunction() noexcept;
} // namespace lux::object::test::benchmark
