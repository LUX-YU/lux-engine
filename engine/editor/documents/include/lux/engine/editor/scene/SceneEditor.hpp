                                                                   ...
                                                                   public DocumentEditor
{
  public:
    ...
    open(NativeScene &, Project &, process::ExecutionRuntime &, rendering::EditorRenderer &,
    ...
    [[nodiscard]] editing::EditResult<lux::world::WorldObjectId>
        createObject(editing::StateId, lux::partition::PartitionOrdinal, EObjectSpace);
    [[nodiscard]] editing::EditResult<editing::ApplyResult> eraseObjects(editing::StateId,
                                                                         std::span<const lux::world::WorldObjectId>);
    ...
    [[nodiscard]] editing::EditResult<std::vector<lux::world::WorldObjectId>>
    placeModel(editing::StateId, const lux::asset::ModelAsset &, const Eigen::Vector3d &,
    ...
    template <class Component, class Value, class Access>
    [[nodiscard]] editing::EditResult<PreviewToken>
    beginPreview(SceneWriteTarget, std::string origin, std::string_view field, std::string_view label, Access);
  ...
  private:
    ...
    [[nodiscard]] editing::EditResult<void> updatePreviewValue(const PreviewToken &, lux::cxx::TypeToken, const void *);
    struct Data;
    SceneEditor(object::ObjectDispatcherRef, std::unique_ptr<Data>);
    std::unique_ptr<Data> data_;
};

[[nodiscard]] LUX_EDITOR_DOCUMENTS_PUBLIC EditorResult<std::unique_ptr<DocumentOpening>>
openSceneDocument(Project &, const OpenDocumentRequest &, process::ExecutionRuntime &, rendering::EditorRenderer &,
                  std::shared_ptr<const lux::scene::SceneMetaManager>);
} // namespace lux::editor::scene
