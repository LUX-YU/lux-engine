...
namespace lux::simulation::ecs
{
    struct EcsSnapshot::Impl final
    {
        ...
        std::unique_ptr<Registry> shadow;
    };
    ...
    namespace
    {
        ...
        void cloneEntities(const Registry& source, Registry& target)
        {
            const auto* source_entities = source.storage<Entity>();
            if (source_entities == nullptr)
                std::terminate();
