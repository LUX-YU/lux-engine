...
//  payload + handler are shared. (User chose "每 feature 通用 setParams op".)
// ============================================================================
...
namespace lux::render
{
    ...
    {
    public:
        explicit FeatureParamsProxy(RenderSession& session) noexcept : session_(&session) {}

        /// @p op = the feature's setParams op-id (FeatureRegistry::paramSetOp(name)).
