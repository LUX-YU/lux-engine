// ============================================================================
//  Scene2D.cpp — install entry impl for the 2D kit (lux::pack).
//
...
#include <lux/pack/d2/pixel/FieldCollisionAdapter.hpp>   // I2-00
...
#include <lux/engine/render_bridge/RenderableSystem.hpp>   // addBridge
