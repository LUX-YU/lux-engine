...
| 11 | 施工 Checklist | 488 个可勾选施工项 | 11_详细施工Checklist.md |
| 12 | 迁移映射总表 | 123 条当前→目标映射 | 12_迁移映射总表.md |
| 13 | 当前代码事实索引 | 47 个关键文件锚点 | 13_当前代码事实索引.md |
...
- `11_详细施工Checklist.md`：项目管理与 Pull Request 跟踪用。
...
这些文档是施工规范，并不表示代码已经修改。实施方必须在每个 Pull Request 中引用 Checklist ID，并同步更新映射表状态。
