...
// ============================================================================
#include <lux/engine/render/core/MaterialFamily.hpp>        // ELightingTechnique, kLightingTechniqueCount
#include <lux/engine/render/pipeline/ShaderPermutation.hpp> // ShaderFeatureMask
