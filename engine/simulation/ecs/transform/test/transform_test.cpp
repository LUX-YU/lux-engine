...
namespace
{
    ...
    void testExistingFoldAndReactiveUpdates()
    {
        ...
        fixture.update();
        assert(detail::TransformSystemTestAccess::visitedNodes(fixture.transform2d) == 0U);
        assert(detail::TransformSystemTestAccess::visitedNodes(fixture.transform3d) == 0U);
    ...
    void testDirtyOverflowRequiresExplicitResyncCapacity()
    {
        ...
        assert(maintenance.update());
        {
            ...
            assert(!updated);
            assert(updated.error() == ETransformUpdateError::CAPACITY_EXCEEDED);
        }
