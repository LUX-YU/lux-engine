...
{
    static constexpr const char *name = "device.frame_lifecycle_call_failed";
    static constexpr const char *message = "帧生命周期阶段 {0} 的 Vulkan 调用失败:{1}";
    static constexpr ERecovery recovery = ERecovery::Permanent;
...
struct SetPartiallyRelocatable
{
    ...
    static constexpr const char *message = "set {0} 会被搬走一半 —— binding {1} 不在契约里,先补齐契约再切这条管线";
    static constexpr ERecovery recovery = ERecovery::NeedsInput;
    static constexpr ErrorArgs args{EErrorArg::Uint, EErrorArg::Uint};
};
...
struct ReflectionIsSubsetOfModule
{
    ...
    static constexpr const char *message = "SPIR-V 里有 {0} 个描述符变量,反射只登记了 {1} 个(元数据漏报,需重烘焙)";
    static constexpr ERecovery recovery = ERecovery::NeedsInput;
    static constexpr ErrorArgs args{EErrorArg::Uint, EErrorArg::Uint};
};
...
struct ReflectionOutOfSyncWithSpirv
{
    ...
    static constexpr const char *message = "应搬 {0} 个变量,实际搬了 {1} 个 —— 反射与 SPIR-V 字节不同源";
    static constexpr ERecovery recovery = ERecovery::NeedsInput;
    static constexpr ErrorArgs args{EErrorArg::Uint, EErrorArg::Uint};
};
} // namespace shader
...
struct StageMergeStateConflict
{
    ...
    static constexpr const char *message = "各 stage 的域合并状态不一致 —— 切换管线必须让全部 stage 都过同一个切换入口";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{};
};
...
struct DomainSlotMismatch
{
    ...
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{EErrorArg::LogicalResource, EErrorArg::BindFrequency, EErrorArg::Uint};
};
...
struct BindingNotInContract
{
    ...
    static constexpr const char *message = "set {0} 的 binding {1} 不在契约里(反射与模块不同源?)";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{EErrorArg::Uint, EErrorArg::Uint};
};
...
struct BindingPositionMismatch
{
    ...
    static constexpr const char *message = "{0} 的反射位置是 (set {1}, binding {2}),与契约推出的域位置不符";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{EErrorArg::LogicalResource, EErrorArg::Uint, EErrorArg::Uint};
};
...
struct ContractResourceNotMerged
{
    ...
    static constexpr const char *message = "set {1} 引用契约资源 {0},但本管线未标记域合并";
    static constexpr ERecovery recovery = ERecovery::Bug;
...
struct DomainWriteTargetEmpty
{
    ...
    static constexpr const char *message = "域写目标为空 —— 该资源的描述符一条都不会被写入(域 set 分配失败?)";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{};
};
} // namespace descriptor
...
struct ImportedResourceIncomplete
{
    ...
    static constexpr const char *message =
        "导入资源 {0} 缺少取值回调(纹理需 image_getter 或 slot,缓冲需 buffer_getter)";
    static constexpr ERecovery recovery = ERecovery::Bug;
...
struct EngineSetUnresolved
{
    ...
    static constexpr const char *message =
        "{0} 的 useEngineSet 未解析到域槽(逻辑集不属 FEATURE/GLOBAL,或本图无域实例)—— 跳过该槽";
    static constexpr ERecovery recovery = ERecovery::NeedsInput;
    static constexpr ErrorArgs args{EErrorArg::GraphPass};
};
...
struct VariantLayoutIncompatible
{
    ...
    static constexpr const char *message =
        "{0}:变体管线与主管线在 set {1} 的布局来源不同 —— 按 pass 绑定的描述符 set 对该变体不兼容";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{EErrorArg::GraphPass, EErrorArg::Uint};
};
...
struct ProjectedLayoutExceedsSetBudget
{
    ...
    static constexpr const char *message =
        "pass {0} 域合并后仍需 {1} 套 set(Vulkan 最低保证 4)—— 保守口径:feature 自有 set 未并入";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{EErrorArg::GraphPass, EErrorArg::Uint};
};
...
struct AuthoredDerivedSlotMismatch
{
    ...
    static constexpr const char *message =
        "slot 语义 {0} → 槽 {1} 在手写与推导两侧不一致(方向 {2}:0=手写有推导无,1=推导有手写无)";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{EErrorArg::Uint, EErrorArg::Uint, EErrorArg::Uint};
};
...
struct TransientUsageViolation
{
    ...
    static constexpr const char *message =
        "{0} 声明 keep_transient,但有 pass 以非附件角色消费它(越界用途位 {1}),按创建者主权丢弃";
    static constexpr ERecovery recovery = ERecovery::Bug;
...
struct ResourceBindingConsumeMissing
{
    ...
    static constexpr const char *message =
        "{0} 的 descriptor slot {1} 没有 declared_consume，依赖对 render graph 不可见";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{EErrorArg::GraphPass, EErrorArg::Uint};
};
...
struct InvalidTime
{
    static constexpr const char *name = "scene.invalid_time";
    static constexpr const char *message = "场景 {0} 的模拟时间必须满足 elapsed >= delta >= 0";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{EErrorArg::Uint};
};
...
{
    static constexpr const char *name = "scene.spatial_origin_rebase_rejected";
    static constexpr const char *message = "场景空间原点重建会让仍存活的渲染对象超出 int32 页差范围";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{};
};
} // namespace scene
...
struct StateTransitionInvalid
{
    ...
    static constexpr const char *message = "GPU 上传请求 {0} 的状态转换无效:当前 {1},目标 {2}";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{
        EErrorArg::Uint,
        EErrorArg::Uint,
...
{
    static constexpr const char *name = "upload.result_identity_mismatch";
    static constexpr const char *message = "GPU 上传请求 {0} 的迟到/重复结果被拒绝(资源 {1},代次 {2})";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{
        EErrorArg::Uint,
        EErrorArg::Uint,
...
struct ReplyTypeMismatch
{
    ...
    static constexpr const char *message = "回复类型不符:期望 TypeId {0},实收 TypeId {1}";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{EErrorArg::Uint, EErrorArg::Uint};
};
...
{
    static constexpr const char *name = "comm.feature_operation_unavailable";
    static constexpr const char *message = "请求的 feature operation 没有已注册的 TypeId";
    static constexpr ERecovery recovery = ERecovery::Bug;
    static constexpr ErrorArgs args{};
};
...
struct LocalReadUnsupported
{
    ...
    static constexpr const char *message =
        "设备未启用 KHR_dynamic_rendering_local_read,无法满足 INPUT_ATTACHMENT 读模式";
    static constexpr ERecovery recovery = ERecovery::Permanent;
    static constexpr ErrorArgs args{};
};
...
namespace frame
{
struct SampledTargetUnavailable
{
    static constexpr const char *name = "frame.sampled_target_unavailable";
    static constexpr const char *message = "采样目标 {0} 的代次、背衬版本、子资源或本帧内容不可用 (期望版本 {1})";
    static constexpr ERecovery recovery = ERecovery::NeedsInput;
    static constexpr ErrorArgs args{EErrorArg::Uint, EErrorArg::Uint};
};
...
#define LUX_RENDER_ERROR_LIST(X)                                                                                       \
    ...
    X(::lux::render::err::frame::SampledTargetUnavailable)                                                             \
