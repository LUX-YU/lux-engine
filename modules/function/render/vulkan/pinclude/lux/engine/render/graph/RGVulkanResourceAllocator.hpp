...
namespace lux::render
{
    ...
    struct TransientResourceKeyHash
    {
        size_t operator()(const TransientResourceKey& k) const noexcept
        {
            ...
            combine(k.mip_levels);
            combine(k.array_layers);
            combine(k.sample);
    ...
    private:
        ...
        std::unordered_multimap<TransientResourceKey, CachedResource, TransientResourceKeyHash> resource_pool_;
    ...
    public:
        ...
        [[nodiscard]] ELazyMemory lazyAttachmentMemory() const noexcept
        {
            return lazy_memory_;
        }
