...
namespace lux::render
{
    ...
    bool Frustum::isAABBInside(const Eigen::Vector3f& aabb_min, const Eigen::Vector3f& aabb_max) const
    {
    ...
    // ─── FrustumCuller ──────────────────────────────────────────────────────
    bool FrustumCuller::isVisible(const Eigen::Vector3f& aabb_min, const Eigen::Vector3f& aabb_max) const
    {
