...
#include <lux/engine/asset/detail/ByteIO.hpp>                // hand-built v1 blob fixture
#include <lux/engine/description/material_graph/Nodes.hpp>   // rdesc graph data model
...
using lux::asset::detail::encodeMaterialGraph;
using lux::asset::detail::decodeMaterialGraph;
...
int main()
{
    ...
    {
        using lux::asset::detail::ByteWriter;
        ByteWriter w;
        w.u32(lux::asset::detail::kMatGraphMagic);
        w.u32(lux::asset::detail::kMatGraphEndianTag);
        ...
        w.u32(lux::asset::detail::kMatGraphTrailer);
