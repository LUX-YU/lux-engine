...
namespace lux::ecs
{
    ...
    void AnimationSystem::update(const lux::ecs::SystemUpdateContext& ctx)
    {
        ...
        // Unloaded Actors are absent from the Registry. Every entity in this
        // view is therefore active; no dormant tag is needed on every system.
