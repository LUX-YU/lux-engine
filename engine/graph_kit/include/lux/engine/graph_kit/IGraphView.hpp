...
//  graph SSOT (rdesc::MaterialGraph, domain graph::FlowGraph, ...).
//
...
//       domain graph FlowGraph::insertNodeAt, material addNodeWithId (P4).
...
namespace lux::graphkit
{
    ...
    public:
        ...
        /// (material setType, domain graph rebind/addExecOutPin). The editor then
