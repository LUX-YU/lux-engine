...
#define LUX_SIMULATION_ECS_SCHEMA_META(...) __attribute__((annotate(#__VA_ARGS__)))
#else
#define LUX_SIMULATION_ECS_SCHEMA_META(...)
#endif
...
#define LUX_COMPONENT(...)                                                                                             \
    LUX_SIMULATION_ECS_SCHEMA_META(luxref::class, type_info = static, component = true, __VA_ARGS__)
