      ...
      public std::enable_shared_from_this<VfsAssetReadEndpoint>
{
  public:
    ...
    [[nodiscard]] static CreateResult create(asset::AssetVfsView vfs, BlockingScheduler blocking, TaskScope &tasks,
    ...
    [[nodiscard]] lux::async::SubmitResult submit(ReadAssetImage operation, void *completion_state,
