...
namespace lux::gapi::vk
{
	...
	public:
		...
		inline operator VkImageView() const noexcept { return view; }
		inline const VkImageView* operator&() const noexcept { return &view; }

		inline VkImageView handle() const noexcept { return view; }
		inline const VkImageView* handlePtr() const noexcept { return &view; }
	...
	public:
		...
		ImageViewBuilder& setSubresourceRange(VkImageAspectFlags aspect, uint32_t baseMipLevel, uint32_t levelCount, uint32_t baseArrayLayer, uint32_t layerCount)
		{
