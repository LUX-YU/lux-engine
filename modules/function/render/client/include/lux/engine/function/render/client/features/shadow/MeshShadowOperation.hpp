...
namespace lux::render
{
    ...
    inline constexpr uint32_t kMeshShadowCommConfigVersion = 3u;  // 3:删 shadow_finalize_shader 死字段(finalize 路径早已退役)
    ...
    struct LUX_COMM_CONFIG(prefix=MeshShadow, id=lux.render.mesh_shadow.v1, display=MeshShadow,
