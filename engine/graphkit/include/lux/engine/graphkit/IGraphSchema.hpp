...
//     flowforge NodePainter virtual: color swatch, texture-slot button, type
...
namespace lux::graphkit
{
    ...
    public:
        ...
        /// centralizes the rules that were implicit in lowerToIR; flowforge
        ...
        /// Open registries (flowforge NodeRegistry) forward their records 1:1;
