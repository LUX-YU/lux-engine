...
class LUX_FUNCTION_PUBLIC InstanceResources : public GPUResourceBase<InstanceResources, EGPUResourceType::Instance>
{
  public:
    ...
    [[nodiscard]] std::optional<ResourceBinding> replaceResources(RenderObjectHandle object,
    ...
    [[nodiscard]] bool beginFadeRetirement(RenderObjectHandle object, float scene_time, float duration_seconds,
    ...
    [[nodiscard]] Expected<void> setDomainWriteTarget(std::span<const VkDescriptorSet> sets, uint32_t binding_offset);
    ...
    [[nodiscard]] uint32_t registerMeshSection(const MeshSectionRecord &section, uint16_t ibo_segment = 0,
