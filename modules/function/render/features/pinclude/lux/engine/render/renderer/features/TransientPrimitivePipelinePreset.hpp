...
namespace lux::render::detail
{
    ...
    [[nodiscard]] inline GraphicsPipelineTemplate makeTransientPrimitivePipelineTemplate(
    ...
    )
    {
        ...
        result.vertex_bindings = {VkVertexInputBindingDescription{0u, vertex_stride, VK_VERTEX_INPUT_RATE_VERTEX}};
        ...
        result.src_color_blend_factor = alpha_blend ? VK_BLEND_FACTOR_SRC_ALPHA : VK_BLEND_FACTOR_ONE;
        result.dst_color_blend_factor = alpha_blend ? VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA : VK_BLEND_FACTOR_ZERO;
        result.color_blend_op = VK_BLEND_OP_ADD;
        result.src_alpha_blend_factor = VK_BLEND_FACTOR_ONE;
        result.dst_alpha_blend_factor = alpha_blend ? VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA : VK_BLEND_FACTOR_ZERO;
