...
namespace lux::asset
{
     ...
     */
    class LUX_ASSET_CODECS_PUBLIC SkeletonSerDeser : public TAssetSerDeser<SkeletonLoadConfig>
    {
    public:
        ...
        [[nodiscard]] static lux::cxx::expected<
            std::unique_ptr<lux::rdesc::Skeleton>,
            EAssetError>
        decodeData(const void* bytes, std::size_t len) noexcept;

        /// Encode deterministic Runtime skeleton bytes without constructing an
        /// AssetManager. Toolchain benchmark and generated-content paths use
        /// the same canonical description codec as imported assets.
        [[nodiscard]] static lux::cxx::expected<
