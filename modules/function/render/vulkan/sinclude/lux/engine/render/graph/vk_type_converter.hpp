...
namespace lux::render
{
    ...
    inline VkImageLayout convertImageLayout(EImageLayout l)
    {
        ...
        case EImageLayout::RENDERING_LOCAL_READ:
    ...
    inline EImageLayout convertVkImageLayout(VkImageLayout l)
    {
        ...
        case VK_IMAGE_LAYOUT_GENERAL:
            return EImageLayout::GENERAL;
        case VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL:
            return EImageLayout::SHADER_READ_ONLY_OPTIMAL;
        case VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL:
            return EImageLayout::DEPTH_STENCIL_READ_ONLY_OPTIMAL;
        case VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ:
            return EImageLayout::RENDERING_LOCAL_READ;
        default:
