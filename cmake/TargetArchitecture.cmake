...
function(_lux_arch_dependency_allowed consumer_layer dependency_layer output)
    ...
    elseif(consumer_layer STREQUAL "DOMAIN")
        if(dependency_layer MATCHES "^(PLATFORM|CORE|RESOURCE|FUNCTION|DOMAIN)$")
            set(allowed TRUE)
        endif()
    elseif(consumer_layer STREQUAL "WORLD")
        if(dependency_layer MATCHES "^(PLATFORM|CORE|RESOURCE|DOMAIN|WORLD)$")
            set(allowed TRUE)
        endif()
    elseif(consumer_layer STREQUAL "SIMULATION")
        if(dependency_layer MATCHES "^(PLATFORM|CORE|RESOURCE|FUNCTION|DOMAIN|SIMULATION)$")
            set(allowed TRUE)
        endif()
    ...
    elseif(consumer_layer STREQUAL "PROCESS")
        if(dependency_layer MATCHES "^(PLATFORM|CORE|RESOURCE|FUNCTION|DOMAIN|WORLD|SIMULATION|PROCESS)$")
            set(allowed TRUE)
        endif()
    elseif(consumer_layer STREQUAL "SCENE")
