                                                                       ...
                                                                       public DocumentEditor
{
  public:
    ...
    [[nodiscard]] editing::EditResult<editing::ApplyResult> setFunctionSignature(
        editing::StateId, lux::flowforge::NodeId, std::string_view name, const lux::flowforge::FlowSourceSignature &);
    ...
    [[nodiscard]] editing::EditResult<editing::ApplyResult> setPinLiteral(lux::flowforge::PinId,
                                                                          const lux::flowforge::FlowSourceLiteral &);
    ...
    [[nodiscard]] editing::EditResult<editing::ApplyResult> disconnect(lux::flowforge::PinId from,
                                                                       lux::flowforge::PinId to);
    [[nodiscard]] editing::EditResult<editing::ApplyResult> moveNodes(std::span<const lux::graph::GraphLayoutEntry>);
    [[nodiscard]] editing::EditResult<editing::ApplyResult> setExports(std::vector<lux::flowforge::ExportMethodNode>);
    ...
    [[nodiscard]] EditorResult<std::reference_wrapper<const lux::script::ScriptArtifact>> compiled(FlowCompileId) const;
...
[[nodiscard]] LUX_EDITOR_DOCUMENTS_PUBLIC EditorResult<std::unique_ptr<DocumentOpening>> openFlowForgeDocument(
    Project &, const OpenDocumentRequest &, process::ExecutionRuntime &, lux::flowforge::FlowSourceEnvironment = {});
} // namespace lux::editor::flowforge
