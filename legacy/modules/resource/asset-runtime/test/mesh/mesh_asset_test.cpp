...
#include <lux/engine/resource/asset/mesh/MeshAsset.hpp>            // lux::asset::{Mesh,Vertex,Bone}
#include <lux/engine/resource/asset/mesh/MeshDescriptionCodec.hpp> // detail::{encode,decode}MeshDescription
