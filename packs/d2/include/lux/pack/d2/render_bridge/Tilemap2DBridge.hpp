...
//  instance + persistent tile-index texture (lux::pack, A2-02).
//
...
#include <lux/pack/d2/world/components/Order2DComponents.hpp>   // A2-03: same rules as sprites
#include <lux/pack/d2/world/components/Camera2DComponent.hpp>   // ActiveCamera2DTag
...
namespace lux::pack
{
    ...
    class Tilemap2DBridge final : public lux::render_bridge::IRenderableBridge
    {
        struct Live
        {
