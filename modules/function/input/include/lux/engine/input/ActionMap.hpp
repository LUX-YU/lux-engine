...
namespace lux::input
{
    ...
    public:
        ...
        {
            std::erase_if(bindings_, [id](const ActionBinding& b) { return b.action == id; });
            return *this;
        }
        ...
        [[nodiscard]] std::span<ActionBinding> bindings()
        {
            return bindings_;
        }
        [[nodiscard]] std::span<const ActionBinding> bindings() const
        {
            return bindings_;
        }
    ...
    private:
        ...
        {
            return BindingIdAllocator::next();
        }
