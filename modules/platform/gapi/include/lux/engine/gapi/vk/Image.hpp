...
namespace lux::gapi::vk
{
    ...
    public:
        ...
        {
            return DeviceMemory{dev, allocation_size, memory_type_index, allocator};
        }
        ...
        inline const VkImage* operator&() const noexcept
        {
            return &image;
        }
        ...
        inline const VkImage* handlePtr() const noexcept
        {
            return &image;
        }
