...
namespace lux::flowforge
{
     ...
     */
    class LUX_FUNCTION_PUBLIC StartNode :  public Node, public HasExecOutPin<StartNode>
    {
    public:
        /**
     ...
     */
    class LUX_FUNCTION_PUBLIC BranchNode : public ExecIntermediateNode
    {
    public:
        /**
     ...
     */
    class LUX_FUNCTION_PUBLIC SequenceNode : public ExecIntermediateNode
    {
    public:
        /**
     ...
     */
    class LUX_FUNCTION_PUBLIC ForLoopNode : public ExecIntermediateNode
    {
    public:
        /**
     ...
     */
    class LUX_FUNCTION_PUBLIC WhileLoopNode : public ExecIntermediateNode
    {
    public:
        /**
	...
	class LUX_FUNCTION_PUBLIC ReturnNode : public Node, public HasExecInPin<ReturnNode>
    {
    public:
        ReturnNode();
