...
lux::render::Expected<void> SsaoFeature::initAndAttachTo(RenderScene& scene)
{
    ...
    GraphicsPipelineTemplate tmpl = makeFullscreenTemplate(
        "Ssao", /*push_constant_size=*/8, /*alpha_blend=*/false);
...
void SsaoFeature::addPasses(RGBuilder& builder)
{
    ...
    auto tds = builder.createTransientDS("SsaoInputDS", input_ds_layout_, {
        {0, EDescriptorType::COMBINED_IMAGE_SAMPLER, linear, input_sampler_,
