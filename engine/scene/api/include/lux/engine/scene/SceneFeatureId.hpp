...
namespace lux::scene
{
    ...
    using SceneFeatureIdView =
        lux::cxx::StableNameIdView<SceneFeatureIdTag>;
    using SceneFeatureId = lux::cxx::StableNameId<SceneFeatureIdTag>;

    [[nodiscard]] constexpr SceneFeatureIdView sceneFeatureId(
        std::string_view name) noexcept
    {
        return SceneFeatureIdView{name};
    }

    [[nodiscard]] inline bool isValidSceneFeatureIdName(
        std::string_view name) noexcept
    {
    ...
    [[nodiscard]] inline bool sameSceneFeatureId(
        SceneFeatureIdView lhs,
        SceneFeatureIdView rhs) noexcept
    {
        return lhs == rhs;
    }

    [[nodiscard]] inline bool sceneFeatureIdCollision(
        SceneFeatureIdView lhs,
        SceneFeatureIdView rhs) noexcept
    {
