...
namespace lux::render
{
    ...
    public:
        ...
        uint32_t upsertNode(uint32_t chunk_id, const GpuOctreeNode& node, TransferScheduler& scheduler);
        ...
        [[nodiscard]] bool hasPendingRemovals() const noexcept
        {
            return !pending_zeros_.empty();
        }
