...
namespace lux::render
{
    ...
    public:
        ...
        /// The vkDescriptorSet for pipelines to bind at set 7.
        [[nodiscard]] VkDescriptorSet descriptorSet() const noexcept { return ds_; }

        /// The VkDescriptorSetLayout — same handle as
        /// GeneralDescriptorSetLayout::getVertexPoolSetLayout() when the
        /// registry is initialized against the same DescriptorService.
