...
namespace lux::object
{
    ...
    public:
        ...
        template <auto& StaticSignal, class Payload> void notify(Payload&& payload)
        {
            ...
            this->notifyIndexed(StaticSignal.runtime(), std::addressof(payload));
        }
        ...
        template <auto& StaticSignal> void notify()
        {
            ...
            contractCheckAffinity();
            this->notifyIndexed(StaticSignal.runtime(), nullptr);
        }
        ...
        observe(Receiver& receiver) requires std::derived_from<Receiver, LuxObject>
        {
            ...
            else
            {
                ...
                static_assert(std::same_as<
                              std::tuple_element_t<0, typename Traits::arguments>,
                              const Payload&>);
        ...
        observeScoped(Callable&& callable)
        {
            ...
            auto result = this->observeCallableIndexed(
                StaticSignal.runtime(),
