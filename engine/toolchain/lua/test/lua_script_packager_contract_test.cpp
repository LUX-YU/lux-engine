...
int main()
{
    ...
    assert(description.event_requirements.front().system_name == "Gameplay");
    assert(description.event_requirements.front().event_name == "damage");
    assert(description.event_requirements.front().system_id == 0x4C554101U);
    assert(description.event_requirements.front().event_id == 0x4C554108U);
