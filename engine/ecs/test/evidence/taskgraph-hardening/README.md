...
```text
py -3 engine/ecs/test/evaluate_l1_qualification.py
  --policy engine/ecs/test/l0_l1_taskgraph_qualification.toml
  --input "engine/ecs/test/evidence/taskgraph-hardening/relwithdebinfo/*.csv"
```
