...
namespace lux::gapi::vk
{
	...
	public:
		...
		DeviceMemory(VkDevice dev, VkDeviceSize size, uint32_t memoryTypeIndex, VkAllocationCallbacks* allocator = nullptr)
		{
		...
		inline operator VkDeviceMemory() const noexcept { return memory_; }
		inline const VkDeviceMemory* operator&() const noexcept { return &memory_; }

		inline VkDeviceMemory handle() const noexcept { return memory_; }
		inline const VkDeviceMemory* handlePtr() const noexcept { return &memory_; }
	private:
