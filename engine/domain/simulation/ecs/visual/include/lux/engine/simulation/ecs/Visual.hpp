...
{
    struct LUX_COMPONENT(schema = "lux.ecs.Mesh3D", version = 2, snapshot = COPY) Mesh3D final
    {
        rdesc::MeshVisualDescription value{};
    };

    struct LUX_COMPONENT(schema = "lux.ecs.Light3D", version = 2, snapshot = COPY) Light3D final
    {
