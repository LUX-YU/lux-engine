...
int main()
{
    ...
    const std::array duplicate_components{
        health_binding,
        health_binding};
    const auto duplicate_backend = LuaScriptBindingBackend::create(
        1U,
    ...
    const auto invalid_backend = LuaScriptBindingBackend::create(
        1U,
    ...
    auto contract_backend_result = LuaScriptBindingBackend::create(
        1U,
