...
namespace lux::object::test::benchmark
{
    ...
    std::uint64_t BaselineReceiver::observed() const noexcept
    {
        return observed_;
    }

    BaselineReceiver* createBaselineReceiver()
    {
        return new BaselineReceiver;
    }
    ...
    BaselineFunction baselineFunction() noexcept
    {
        return &invokeBaseline;
    }
} // namespace lux::object::test::benchmark
