    ...
    class LUX_ENGINE_SCENE_PUBLIC SceneBuilder final
    {
      public:
        ...
        [[nodiscard]] lux::cxx::expected<Configuration, SceneSystemBuildFailure> decodeConfiguration(
            SceneSystemView description) noexcept
        {
            ...
            {
                return lux::cxx::unexpected(
                    SceneSystemBuildFailure{ESceneSystemBuildError::CONFIGURATION_DECODE_FAILURE,
        ...
        [[nodiscard]] lux::cxx::expected<Type *, SceneSystemBuildFailure> emplaceSystem(
            system::SystemInstanceId instance, Args &&...args) noexcept
        {
            const auto *registration = currentRegistration();
            ...
            {
                return lux::cxx::unexpected(
                    SceneSystemBuildFailure{ESceneSystemBuildError::ALLOCATION_FAILURE, instance});
            }
            catch (...)
            {
                return lux::cxx::unexpected(
        ...
        {
            return addHook<Type>(instance, std::forward<Callable>(callable));
        }
      ...
      private:
                                                                                ...
                                                                                Callable &&callable) noexcept
        {
            ...
            try
            {
                lux::cxx::move_only_function<bool()> invoke(
                    [object = static_cast<Type *>(system),
                     function = Function(std::forward<Callable>(callable))]() noexcept
                    {
                ...
                return addHookErased(instance, std::move(invoke));
            }
            catch (const std::bad_alloc &)
            {
                return lux::cxx::unexpected(
        ...
        [[nodiscard]] lux::cxx::expected<void *, SceneSystemBuildFailure> appendSystem(
            system::SystemInstanceId instance, lux::cxx::TypeToken type,
            const system::SystemTypeDescription *description, void *object, object::LuxObject *endpoint,
