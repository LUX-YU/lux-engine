...
namespace lux::rdesc
{
    ...
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC ConstantNode : public Node
    {
    public:
    ...
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC InputNode : public Node
    {
    public:
    ...
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC SampleTextureNode : public Node
    {
    public:
    ...
    /// output pin).
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC ParamNode : public Node
    {
    public:
    ...
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC MathNode : public Node
    {
    public:
    ...
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC DecodeNormalNode : public Node
    {
    public:
    ...
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC TbnTransformNode : public Node
    {
    public:
    ...
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC SwizzleNode : public Node
    {
    public:
    ...
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC ConstructNode : public Node
    {
    public:
    ...
    class LUX_ENGINE_AUTHORING_ASSETS_PUBLIC OutputSurfaceNode : public Node
    {
    public:
