...
namespace lux::render
{
    ...
    struct LUX_COMM_CONFIG(prefix=Grid2D, id=lux.render.grid2d.v1, display=Grid2DPass,
    ...
    struct LUX_OP(lane=frame, kind=stream, name=Grid2DSetParams, method=setParams)
    Grid2DSetParamsPayload
    {
