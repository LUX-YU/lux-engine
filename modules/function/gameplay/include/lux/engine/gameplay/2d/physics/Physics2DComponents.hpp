...
//  lux::gameplay::d2). Components + the collision-probe seam; NO solver here.
//
...
namespace lux::gameplay::d2
{
    ...
    /// The external-collision seam (P2-00): any solid the controller should
    /// collide with that is NOT a Collider2D entity — the pixel field's
    /// FieldCollisionAdapter (I2-00) is the intended first implementer. The
    /// physics layer calls ONLY this; it never sees the provider's internals.
