...
//  (lux::pack, v2 — .internal/2d-gpu-driven-rewrite.md §3.5).
//
...
#include <lux/engine/render_bridge/RenderableBridgeContext.hpp>       // ctx.canvas2d() / scene()
...
#include <lux/pack/d2/world/components/Order2DComponents.hpp>       // A2-03: Y-sort / parallax
#include <lux/pack/d2/world/components/Camera2DComponent.hpp>       // ActiveCamera2DTag (parallax origin)
...
namespace lux::pack
{
    ...
    class Sprite2DBridge final : public lux::render_bridge::IRenderableBridge
    {
