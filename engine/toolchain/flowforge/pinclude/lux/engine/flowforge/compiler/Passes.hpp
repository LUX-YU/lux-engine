...
namespace lux::flowforge
{
    ...
    [[nodiscard]] FlowForgeResult<void> lowerToCF(IR& ir) noexcept;
    ...
    [[nodiscard]] FlowForgeResult<void> lowerToLLVM(IR& ir) noexcept;
    ...
    [[nodiscard]] FlowForgeResult<int> runMainJIT(IR& ir) noexcept;
