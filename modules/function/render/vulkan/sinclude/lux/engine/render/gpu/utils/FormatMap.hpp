#pragma once
#include <lux/engine/common/ImageEnums.hpp>   // ETextureFormat(本表唯一所需;不再借道 graph 消 utils→graph 环)
...
{
    // ── VkFormat -> lux::common::ETextureFormat(唯一权威表) ────────────────
    //
    ...
    /// lux::common::ETextureFormat -> VkFormat。原住 graph/vk_type_converter.hpp,
