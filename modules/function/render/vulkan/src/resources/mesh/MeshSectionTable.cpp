...
MeshSectionTable::SectionKey MeshSectionTable::makeSectionKey(const MeshSectionRecord& section,
...
void MeshSectionTable::unregisterSection(uint32_t section_id)
{
    ...
    const VkIndexType index_type = section_id < index_types_.size()
        ? index_types_[section_id]
