...
namespace lux::engine::platform
{
    ...
    public:
        ...
        LUX_EXPORT static float timeAfterFirstInitialization();

    private:
        void _common_constructor(int width, int height, std::string title, GraphicAPI api);
