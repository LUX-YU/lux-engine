...
static int resumeAuthorityCase(bool stop)
{
    ...
    description.exports = {{"tick", kTick, {lux::rdesc::makeScriptValueType<ValuePose>()}, {}}};
    ...
    std::printf("SYNC_CONVERTER_RETIRE conversions=%zu body_calls=%zu entity_valid=%u expected_body_calls=0\n", resume_conversions, audit_body_calls, registry.valid(entity));
