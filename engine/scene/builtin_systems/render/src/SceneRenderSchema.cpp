...
namespace lux::serialization
{
    template <> struct Serializer<scene::Camera>
    {
        ...
        static SerializationResult write(
            Writer& writer, const scene::Camera& value, const SerializationContext& context) noexcept
        {
        ...
        static SerializationResult read(
            Reader& reader, scene::Camera& value, const SerializationContext& context) noexcept
        {
            ...
            if (!scene::cameraProjection(decoded))
            {
                return lux::cxx::unexpected(SerializationFailure{
                    ESerializationError::INVALID_VALUE, reader.offset()});
            }
